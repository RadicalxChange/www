...
私たちは、公の場での執筆と参加の管理を可能にするソフトウェアで実現される基盤をまもなく公開しますが、それ以前に貢献したい方法を思いついた場合には、どうか glen@radicalxchange.org 宛にお知らせください。私たちが協力してテクノロジーを想像し説明することで、テクノロジーの未来は、私たちが大切にしている価値を尊重し可能にするものになれます。
