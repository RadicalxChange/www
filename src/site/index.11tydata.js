module.exports = {
  rxcTv: {
    ...
    description: `May 13th, 3:30 pm to 5:00 pm UTC
...
Register to join this thought-provoking panel and get involved in the conversation by asking questions on Slido, tweeting us @radxchange (#RxCLiveTalk), and sharing this event.
...
Matt Prewitt (@m_t_prewitt) is RadicalxChange Foundation’s president, a writer, and blockchain industry advisor, and a former plaintiff's side antitrust and consumer class action litigator and federal law clerk.`,
  ...
  popup: {
    isOn: true,
    title: "Announcing the Next Annual RxC Conference August 2022",
